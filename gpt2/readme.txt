When training, run "gpt_train.py". Notice that, if you run the training file first time, please use "python gpt_train.py --raw" to tokenize.
When calculating the perplexity, run "gpt2_ppl.py".
When testing, run "gpt2_test.py" for a single process and run "gpt_multi_test/generate.py" for parallel computing.
